...
final class SecondVC: UIViewController {
	...
	smart and will assign its data type properly, but
	you can still do it manually, e.g, counter is an integer
	...
	@objc private func fadeIn() {
		UIView.animate(withDuration: 0.5, delay: 0.3, options: .transitionCrossDissolve, animations: {
			...
			and this is one of them because it's within a closure ---*/
